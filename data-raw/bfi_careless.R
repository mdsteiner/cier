...
# (CC BY 4.0). This reads a vetted intermediate copy of that data (semicolon-free,
# UTF-8, PII-removed) under archive/, which is git-ignored and NOT distributed --
# if it is absent, recreate it from the MD5-verified OSF download documented in
# data-raw/bruhlmann-2020-data-quality-SOURCE.md (drop the two free-text / PII
# columns and re-save as a UTF-8, comma-separated file), then re-run. The script
# trims that copy to the 44 BFI-44 items plus the two independent attention-check
# indicators.
#
