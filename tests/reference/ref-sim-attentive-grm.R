...
# cier_simulate() uses to generate careful-respondent data (Slice 24).
#
...
# plus paper-anchored pins through the shipped indices (Slice 25) are the sole
# trust, oracle-only like personal reliability. See tests/reference/TOLERANCES.md.
#
# Three pieces:
...
# The five named marginal-shape presets, as agreed (Markus, 2026-06-11). Every
