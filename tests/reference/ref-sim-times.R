...
# careless plan (Slice 26 of the simulation engine).
#
...
# randomised re-derivations coordinate their DRAW ORDER with production (a
# deliberate reproducibility constraint recorded in TOLERANCES.md, not a
# tautology: the arithmetic is recomputed independently, per cell, by hand).
# The simulator is a generator with no CRAN parity partner (verified
# 2026-06-11), so trust is oracle-only. See tests/reference/TOLERANCES.md.
