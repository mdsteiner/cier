...
# value is the validated seconds vector itself (an identity). What these tests
# pin is therefore the CONTRACT, not a derivation: that the wrapper applies no
...
# wrapper, so the target tolerance is 0 (exact)
