# print renders the locked cli summary (default battery)
    ...
    Output
      ...
      Notes:
        * cier_psychsyn: no synonym pairs at critical_r = 0.6 (strongest in-tail r = 0.19); see cier_psychsyn_critval()
        * cier_psychant: no antonym pairs at critical_r = 0.6 (strongest in-tail r = -0.198); see cier_psychsyn_critval(antonym = TRUE)
      
      Cross-index agreement (observed vs independence baseline):
        flagged by >= 1 vote: 71 / 300 (23.7%); expected 23.9%
        flagged by >= 2 votes: 5 / 300 (1.7%); expected 1.7%
        flagged by >= 3 votes: 1 / 300 (0.3%); expected <0.1%
...
# print reports skipped methods with their reasons
    ...
    Output
      ...
      Notes:
        * cier_psychsyn: no synonym pairs at critical_r = 0.6 (strongest in-tail r = 0.295); see cier_psychsyn_critval()
        * cier_psychant: no antonym pairs at critical_r = 0.6 (strongest in-tail r = -0.467); see cier_psychsyn_critval(antonym = TRUE)
